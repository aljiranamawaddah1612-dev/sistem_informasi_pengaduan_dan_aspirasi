        ...
        <div class="card-body p-4">
            <form action="{{ route('faq.store') }}" method="post" class="form">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="pertanyaan" id="pertanyaan" class="form-control form-control-lg bg-light" required value="{{ old('pertanyaan') }}" placeholder="Contoh: Bagaimana cara mereset password?">
                </div>
                <div class="mb-4">
                    <label for="jawaban" class="form-label required fw-bold text-muted small">JAWABAN</label>
                    <textarea name="jawaban" id="jawaban" rows="4" class="form-control bg-light" required placeholder="Jawaban dari pertanyaan...">{{ old('jawaban') }}</textarea>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary px-4 rounded-pill fw-semibold shadow-sm"><i class="bx bx-save me-1"></i> Simpan FAQ</button>
                </div>
            </form>
        </div>
    </div>
